...
export interface ICustomSbResult<T> extends Omit<ISbResult, 'data'>, Omit<ISbStory, 'headers' | 'data'> {
...
export interface ICustomSbResults<T> extends Omit<ISbResult, 'data'>, Omit<ISbStory, 'headers' | 'data'> {
  data: Omit<ISbStory['data'], 'story'> & {
